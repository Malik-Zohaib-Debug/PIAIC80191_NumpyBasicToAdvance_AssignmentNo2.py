...
def function3():
    ...
    #example [35,70,105,..]
    a = np.arange(1, 100*10+1).reshape((100,10))    #wrtie your code here
...
def function7():
    ...
    X = np.random.randint(low=0, high=1, size=(4))
...
def function8():
    ...
    x = np.random.randint(low=6, high=7, size=(2,5)) #write your code here
...
def function10():
    ...
    brr = np.array([1,2,3])
    subt = arr-brr(-1,1)# write your code here 
...
def function13():
    ...
    ans = arr[(arr>5)&(arr)]#write your code here 
...
def function19():
    ...
    X =  np.arange(1,16).reshape(5,5) # Write your code here
